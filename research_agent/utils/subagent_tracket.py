...
class SubagentSession:
    """Information about subgent execution session"""
    subagent_type: str
...
class SubagentTracker:
    """
    Track all tool calls made by subagents using both hooks and message stream parsing.
    ...
    def __init__(self, transcript_writer= None, session_dir: Optional[Path] = None):
        ...
        # Counter for each subagent (from message stream)
        ...
        # Tool call detail log (JSON format)
    ...
    def _format_tool_input(self, tool_input: Dict[str, Any], max_length: int = 100) -> str:
        ...
        # Write: show file paht and content size
    ...
    async def pre_tool_use(self, hook_input, tool_use_id, context):
        """Hook call for PreToolUse events - captures tool calls."""
